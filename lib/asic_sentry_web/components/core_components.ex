defmodule AsicSentryWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AsicSentryWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AsicSentryWeb.Gettext, "errors", msg, opts)
    end
  end
